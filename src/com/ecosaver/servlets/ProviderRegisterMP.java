...
/**
 * Servlet implementation class ProviderRegisterMP
 */
public class ProviderRegisterMP extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProviderRegisterMP() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        if (result > 0) {
	            // Redirect to Manage Providers page after successful registration
	            response.sendRedirect("manage_provider.jsp");
	        } else {
	        ...
	        e.printStackTrace();
	        response.getWriter().println("<h3>Error occurred. Please check server logs.</h3>");
	    }
